...
<?php
    ...
    if(isset($_POST['submitsignup']))
    {
       ...
       // $ConfirmPassword=$_POST['ConfirmPassword'];
        ...
        $query2="INSERT INTO donarsign2(DonarName,Contact,Email,Location,Password) VALUES('$DonarName','$Contact','$Email','$Location','$Password');";
        ...
        <div class="container">
            ...
            <div class="top">
               <!-- <span>Have an account?</span> -->
                ...
                <form id="sign-up-data" class="sign-up-data" method="post" action="donar-signup.php" >
                
            </div>
    
            <div class="input-field">
                <input type="text" class="input" placeholder="DonarName" id=""name="DonarName" required minlength="2" maxlength="100">
...
<!--<div class="container">
        ...
        <h1>Sign Up</h1>
            ...
            <form id="sign-up-data" class="sign-up-data" method="post" action="donar-signup.php" >
                ...
                <input type="text" id="name" placeholder="Full name" name="DonarName"
