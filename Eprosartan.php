...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  //  $Medicine_name = $_POST['Medicine_name'];
   ...
   // $Description = $_POST['Description'];
    ...
    $query1 = "INSERT INTO epros(Name,Phone, Email, Manufacture_date, Expiry_date,  Quantity, Address, City) VALUES ('$Name','$Phone', '$Email', '$Manufacture_date', '$Expiry_date', '$Quantity', '$Address', '$City')";
...
<body>
<div class="container">
    <form id="donate-form" class="donate-form" data-aos-easing="ease-in-out" method="post" action="Eprosartan.php">
        <div class="row">
            <div class="col">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    ...
                    <input type="text"  value="Eprosarten" readonly>
                </div>
                <div class="inputBox">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" value="For symptoms of cardiovascular conditions" readonly>
                </div>
                <div class="inputBox">
                    <span>Count :</span>
