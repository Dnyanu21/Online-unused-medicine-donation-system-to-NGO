...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  //  $Medicine_name = $_POST['Medicine_name'];
   ...
   // $Description = $_POST['Description'];
    ...
    $query1 = "INSERT INTO amlod(Name,Phone, Email, Manufacture_date, Expiry_date,  Quantity, Address, City) VALUES ('$Name','$Phone', '$Email', '$Manufacture_date', '$Expiry_date', '$Quantity', '$Address', '$City')";
...
<body>
<div class="container">
    <form id="donate-form" class="donate-form" data-aos-easing="ease-in-out" method="post" action="Amlodipine.php">
        <div class="row">
            <div class="col">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    ...
                    <input type="text"  value="Amlodipine" readonly>
                </div>
                <div class="inputBox">
                    <span>Manufacture Date :</span>
                    <input type="date" placeholder="MM/DD/YYYY" name="Manufacture_date">
                </div>
                <div class="inputBox">
                    <span>Expiry date :</span>
                    <input type="date" placeholder="MM/DD/YYYY" name="Expiry_date">
                </div>
                <div class="inputBox">
                    <span>Description :</span>
                    <input type="text" value="For less blood supply to heart" readonly>
                </div>
                <div class="inputBox">
                    <span>Count :</span>
                    <input type="number" placeholder="eg. 5" name="Quantity">
                </div>
            </div>
        </div>
