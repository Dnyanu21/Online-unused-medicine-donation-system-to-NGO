...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  //  $Medicine_name = $_POST['Medicine_name'];
   ...
   // $Description = $_POST['Description'];
    ...
    $query1 = "INSERT INTO captro(Name,Phone, Email, Manufacture_date, Expiry_date,  Quantity, Address, City) VALUES ('$Name','$Phone', '$Email', '$Manufacture_date', '$Expiry_date', '$Quantity', '$Address', '$City')";
...
<body>
<div class="container">
    <form id="donate-form" class="donate-form" data-aos-easing="ease-in-out" method="post" action="captopril.php">
        <div class="row">
            <div class="col">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                   ...
                   <!-- <input type="text" placeholder="Enter Medicine name" name="Medicine_name">-->
                    <input type="text"  value="Captopril" readonly>
                </div>
                <div class="inputBox">
                ...
                <div class="inputBox">
                  ...
                  <!--  <input type="text" placeholder="Description of medicine" name="Description">-->
                    <input type="text" value="For high blod pressure and heart failure" readonly>
                </div>
                <div class="inputBox">
                    <span>Count :</span>
